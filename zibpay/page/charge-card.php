...
switch ($tab) {
    ...
    case 'add':
        ...
        $csf_fields[] = array(
            ...
            <li>自定义参数格式为：<code>card_name=卡号&password_name=卡密</code>,card_name为卡号的显示名称，password_name为卡密的显示名称，可以留空</li>
            <li>单次导入数量太多可能会对服务器性能造成影响</li>
            <p><b>数据示例</b></p>
            <div>4849977843617 3w20V4Qe7dRhAIoPYum6KSA 平台卡密01 card_name=卡号&password_name=兑换码</div>
            <div>6484027668705 SkdJZ5vWcpqPxrbs3pqPcpq 平台卡密01 card_name=卡号&password_name=兑换码</div>
        ...
        $csf_fields[] = array(
            ...
            <li>默认使用空格分割，您可以在下方自定义分割符号，与您的数据对应即可</li>
            <li>单次导入数量太多可能会对服务器性能造成影响</li>
            <li>自定义参数格式为：<code>password_name=卡密</code>，password_name为卡密的显示名称，可以留空</li>
            <p><b>数据示例</b></p>
            <div>3w20V4Qe7dRhAIoPYum6KSA 平台卡密01 password_name=兑换码</div>
            <div>SkdJZ5vWcpqPxrbs3pqPcpq 平台卡密01 password_name=兑换码</div>',
            'style'      => 'warning',
            'type'       => 'submessage',
        );
        $csf_fields[] = array(
