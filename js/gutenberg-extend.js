(function ($, wp, window) {
    $(document).ready(function () {
        ...
        rB('zibllblock/seamlessimg', {
            title: show_title('无缝图'),
            description: '多张图片组成的无缝大图，更加适合于商品详情图片等布局',
            className: false,
                ...
                return el(
                    ...
                    el(
                        ...
                        el(
                            ...
                            jza,
                            el('p', { className: 'px12 opacity5' }, '启用此配置后，图片宽度会填满容器，如果是在商城中使用，开启商城的内容全屏布局后，则宽度会填满屏幕')
                        )
                    )
                );
            },
            ...
            edit: function (props) {
                    ...
                    props.isSelected
                        ? el(
                              ...
                              el(TextControl, {
                                  ...
                                  value: content,
                                  // type: 'number',
                                  placeholder: '请输入商品ID或输入关键词搜索商品',
                                  label: '请输入商品ID或输入关键词搜索商品',
                              }),
                              that.loading &&
                                  el(c.Spinner, {
                                      style: {
                        ...
                        : el(
                              ...
                              ~~content ? '[ID:' + content + ']' + (that.post_title ? that.post_title : '') : '商品ID无效'
                          )
                );
                ...
                return el(
                    ...
                    el(
                        ...
                        '以卡片的形式显示商城的商品（注意：如未开启商城功能，前台则不会显示）'
                    ),
                    rti,
                    props.isSelected &&
                        that.search_lists.length > 0 &&
